#!/usr/bin/env python3
"""Debug del problema de namespace en send_recibe_lote"""
...
print(f"\ndId extraído: {dId_val}")
print(f"xDE extraído: {'(presente)' if xDE_val else None}")

# Construir SOAP como lo hace send_recibe_lote
from app.sifen_client.soap_client import SIFEN_NS, SOAP_NS, _preferred_envio_root_name
...
print("\n=== SOAP generado ===")
print(payload_xml[:500] + "...")

# Verificaciones
print("\n=== Verificaciones ===")
xmlns_check = f'xmlns="{SIFEN_NS}"'
print(f'xmlns="{SIFEN_NS}" presente: {xmlns_check in payload_xml}')
print("<rEnvioLote> presente:", "<rEnvioLote>" in payload_xml)
print("<dId> presente:", "<dId>" in payload_xml)
print("<xDE> presente:", "<xDE>" in payload_xml)

# Guardar para inspección
with open("debug_soap_generated.xml", "w") as f:
    f.write(payload_xml)
print("\nSOAP guardado en debug_soap_generated.xml")
